    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Enter a name to identify your deck', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.CharField(help_text='This should be the name of the image', max_length=255)),
